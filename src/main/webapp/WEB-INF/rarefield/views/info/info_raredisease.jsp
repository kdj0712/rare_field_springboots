                                    ...
                                    resultList = new ArrayList<>();
                                      ...
                                      <div class="justify-content-center row">
                                        <div class="row col-7" style="align-items: center;">
                                          <div class="col-3">
                                            <select style="border-radius: 25px;" id="keyNameSelect" class="form-control"
                                              name="key_name">
                                          ...
                                          <div class="col-7">
                                            <input id="searchWordInput" class="form-control" placeholder="Enter Search!"
                                              name="search_word" value="${search_word != null ? search_word : ''}">
                                          </div>
                                              ...
                                              <td>
                                                <c:choose>
                                                  <c:when test="${not empty record.dise_url}">
                                                    <a style="border:none; background: none;" href="${record.dise_url}"
                                                      target="_blank">
                                      ...
                                      <nav aria-label="Page navigation">
                                        <ul class="pagination justify-content-center">
                                          ...
                                          <li class=" page-item {{ '' if pagination.has_next_page else 'disabled' }}">
                                            <a style="border: none; background: none;" class="page-link"
                                              href="javascript:void(0);"
                                              onclick="goToPage(${paginations.blockEnd});return false;"><svg width="13"
