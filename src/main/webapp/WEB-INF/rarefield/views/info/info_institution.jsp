              ...
              <%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
                ...
                <%@ include file="/WEB-INF/rarefield/views/commons/header.jsp" %>
                  ...
                  <main class="row justify-content-between">
                    ...
                    <% String keyword=(String) request.getAttribute("keyword"); String pos=(String)
                      request.getAttribute("pos"); int startRecordNumber=(request.getAttribute("StartRecordNumber")
                      !=null) ? (int) request.getAttribute("StartRecordNumber") : 1; List<Map<String, Object>> results
                              ...
                              <form action="" id="maps" class="container">
                                <div class="row">
                                  ...
                                  <div class="col-12">
                                    ...
                                    <button type="button" formmethod="get"  style="border:none; background: none;"
                                            ...
                                            <tr>
                                              ...
                                              <td class="td">
                                                <c:if test="${not empty result.YPos && not empty result.XPos}">
                                                  <a href="#"
                                                    onclick="focusOnMap(${result.YPos}, ${result.XPos},${status.index}); return false;"
