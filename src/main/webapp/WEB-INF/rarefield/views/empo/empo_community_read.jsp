                            ...
                            <div class="container">
                                <form action="">
                                    <% HashMap result=(HashMap) request.getAttribute("result"); %>
                                        ...
                                        <div>
                                            <h3>
                                                <%= result.get("community_title") %>
                                            </h3>
                                            <div>
                                                <%= result.get("community_choice") %>
                                            </div>
                                            <div style="font-size: small;" class="text-end">
                                                <%= result.get("user_ID") %> | <%= result.get("community_date") %>
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <button type="submit" class="btn btn-primary"
                                                formaction="/empo_community/selectSearch" formmethod="get">List</button>
                                            <sec:authorize access="isAuthenticated()">
                                                <c:if test="${userDetailsBean.username.equals(result.get('user_ID'))}">
                                                    <button type="submit" class="btn btn-success"
                                                        formaction="/empo_community/update"
                                                        formmethod="get">UPDATE</button>
                                                    <button type="submit" class="btn btn-danger" name="btn_type"
                                                        formaction="/empo_community/list_pagination"
