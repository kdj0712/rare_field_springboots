...
<head>
    ...
    <link rel="icon" type="image/png" href="http://rare-field.shop:80/data/img/favicon.ico">
    <style>
        #maps >*{
    ...
    <div class="container-fluid">
        <div
            ...
            <a href="/"
                ...
                <span class="fs-4"><img width="200" src="http://rare-field.shop:80/data/img/RDS_logo.png" alt=""></span>
            </a>
