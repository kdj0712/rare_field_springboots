...
{% block main_container %}
    ...
    <div class="row justify-content-start ms-1" style="transform: translate3d(0px, 0px, 0px);">
        <div id="topic" data-idx="0" class="swiper-slide selected swiper-slide-active col-2">
            <a href="/" class="nuxt-link-exact-active nuxt-link-active"
                aria-current="page">토픽 전체</a></div>
        <div id="topic" data-idx="1" class="swiper-slide swiper-slide-next col-2"><a
                href="/" class="">토픽 베스트</a></div>
        <div id="topic" data-idx="2" class="swiper-slide col-2"><a href="/"
                class="">주류탐험</a></div>
        <div id="topic" data-idx="3" class="swiper-slide col-2"><a href="/"
                class="">나들이 명소</a></div>
        <div id="topic" data-idx="4" class="swiper-slide col-2"><a href="/" class="">OTT뭐볼까</a>
        </div>
    </div>
