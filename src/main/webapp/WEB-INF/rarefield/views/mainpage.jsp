...
<div class="image-container mb-5">
    <img class="container-fluid" src="http://rare-field.shop:80/data/img/wordcloud.png" alt="" class="bottom-image">
    <img class="container-fluid" src="http://rare-field.shop:80/data/img/logo_in_cloud.png" alt="" class="top-image">
</div>
